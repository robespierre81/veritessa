...
function getClosestHandle(pos, connectionRadius, handles, validator) {
    let closestHandles = [];
...
function handlePointerDown({ event, handleId, nodeId, onConnect, isTarget, getState, setState, isValidConnection, edgeUpdaterType, onEdgeUpdateEnd, }) {
    ...
    function onPointerMove(event) {
        ...
        const { handle, validHandleResult } = getClosestHandle(pointToRendererPoint(connectionPosition, transform, false, [1, 1]), connectionRadius, handleLookup, (handle) => isValidHandle(event, handle, connectionMode, nodeId, handleId, isTarget ? 'target' : 'source', isValidConnection, doc));
